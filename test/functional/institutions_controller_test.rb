...
class InstitutionsControllerTest < ActionController::TestCase
  ...
  test "should create institution" do
    assert_difference('Institution.count') do
      post :create, institution: { basic_info: @institution.basic_info, logo: @institution.logo, name: @institution.name, website: @institution.website }
    end
  ...
  test "should update institution" do
    put :update, id: @institution, institution: { basic_info: @institution.basic_info, logo: @institution.logo, name: @institution.name, website: @institution.website }
    assert_redirected_to institution_path(assigns(:institution))
  end
