...
class FollowersControllerTest < ActionController::TestCase
  ...
  test "should create follower" do
    assert_difference('Follower.count') do
      post :create, follower: { rating: @follower.rating, report_id: @follower.report_id, user_id: @follower.user_id }
    end
  ...
  test "should update follower" do
    put :update, id: @follower, follower: { rating: @follower.rating, report_id: @follower.report_id, user_id: @follower.user_id }
    assert_redirected_to follower_path(assigns(:follower))
  end
